...
# Cheston
# CUDA_VISIBLE_DEVICES=0 FORCE=1 TEST_MODE=0 ./run_sam3dbody_for_mocap_dataset.sh --DATA_ROOT /home/haziq/datasets/mocap/data/humaneva/ --shard 0 --num_shards 3 --ignore-cams "BW1,BW2,C2" 2>&1 | tee humaneva_shard0_part0.txt
# CUDA_VISIBLE_DEVICES=1 FORCE=1 TEST_MODE=0 ./run_sam3dbody_for_mocap_dataset.sh --DATA_ROOT /home/haziq/datasets/mocap/data/humaneva/ --shard 1 --num_shards 3 --ignore-cams "BW1,BW2,C2" 2>&1 | tee humaneva_shard1_part0.txt
# CUDA_VISIBLE_DEVICES=2 FORCE=1 TEST_MODE=0 ./run_sam3dbody_for_mocap_dataset.sh --DATA_ROOT /home/haziq/datasets/mocap/data/humaneva/ --shard 2 --num_shards 3 --ignore-cams "BW1,BW2,C2" 2>&1 | tee humaneva_shard2_part0.txt
